...
[plexDIA](https://scp.slavovlab.net/plexDIA) quantifies about a thousand proteins per single cell while parallelizing the analysis of both single cells and peptides and achieving 98% data completeness within a set. It does not use a carrier sample.
